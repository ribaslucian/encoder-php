...
<html lang="pt-BT">
    <head>
        ...
        <title>Encoder &minus; Admin</title>

        <!-- informações básicas -->
        <meta name="description" content="Layout ADMIN de uma página HTML desenvolvida com o framework Enconder-PHP">
