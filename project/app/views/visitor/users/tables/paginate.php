            ...
            <td class="center-align">
                <div class="dropdown">
                    ...
                    <div class="menu left center vertical">
                        ...
                        <a href="<?php echo url_auth('/visitor/users/sign_up'); ?>" class="item icon">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="menu top center horizontal">
                            ...
                            echo element('button/post', array(
                                'url' => '/visitor/users/email_password_renew',
                            ...
                            <?php
                            echo element('button/post', array(
                                'url' => '/visitor/users/email_confirm_account',
                                'content' => '<input name="User[id]" value="' . $u->id . '" type="hidden" />',
                                'submitter' => '<div class="item">
                            ...
                            <?php
                            echo element('button/post', array(
                                'url' => '/visitor/users/email_unlock_account',
                                'content' => '<input name="User[id]" value="' . $u->id . '" type="hidden" />',
                                'submitter' => '<div class="item">
